...
> **Current roadmap (2026-09-06).** Phases 16 and 17 are complete; Phase 18 below is next.
> Phases 16–21 replace the earlier numbered Rules/learning, Analytics and Natural-language
...
> ADR-0018 (item refunds)'s attribution schema and validation, are now **shipped**. The item
> refund **allocation engine** — turning net item costs into a superseding allocation and new
> obligations — remains Phase 18, exactly as ADR-0018 scheduled it.
...
| 18  | Item-Level Refund Allocation Engine & Scenario Test Matrix | **Not started.** Item refund → net expense → allocation → obligation; shared-item, refund, rounding and history scenarios.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 19  | Splitwise Drift & Ghost-Debt Auditing Engine               | **Not started.** Extend Phase 15 aggregate drift detection with evidence-backed attribution and reviewable ghost-debt findings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 20  | Derived Proof Packs                                        | **Not started.** Recipient-specific WhatsApp summaries, evidence references and preview/redaction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
**Phase 18: Item-Level Refund Allocation Engine & Scenario Test Matrix.** Read
[ADR-0018 (item refunds)](decisions/0018-item-level-refund-attribution.md),
[ADR-0008](decisions/0008-refunds-and-reimbursements-as-adjustments.md),
[ADR-0012](decisions/0012-deterministic-money-rounding.md),
[ADR-0013](decisions/0013-full-refund-preserves-allocation-shape.md) and `CLAUDE.md` before
implementation. Phase 16 already ships `ExpenseAdjustmentItem`, its validation and its
cumulative ceilings under a row lock; what is missing is the engine that turns net item costs
into a superseding `Allocation` and new obligations. Inspect `services.recordExpenseAdjustment`,
`services.distributeAdjustment` and `domain.refund-attribution` before adding anything — the
attribution half exists and must be extended rather than rebuilt.
