...
> **Current roadmap (2026-09-05).** Phase 15 is complete; Phase 16 below is next.
...
> ADR-0017 (cash balance) and ADR-0018 (item refunds) are accepted designs, not shipped features.
...
| 16  | ADR-0017 & ADR-0018 Schema & Domain Extension              | **Next — not started.** Drizzle migrations, cash-flow classification, account snapshots, adjustment items and deterministic domain/integration tests.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 17  | Evidence Enrichment & Context Re-attachment Service        | **Not started.** Bank statement ↔ SMS/push/receipt matching with local PII sanitization and traceable review.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
**Phase 16: ADR-0017 & ADR-0018 Schema & Domain Extension.** Read
[ADR-0017 (cash balance)](decisions/0017-pragmatic-cash-balance-reconciliation.md),
[ADR-0018 (item refunds)](decisions/0018-item-level-refund-attribution.md), `CLAUDE.md`,
`docs/domain/domain-model.md`, `docs/domain/invariants.md` and `docs/domain/lifecycle.md` before
implementation. Inspect the current code and migrations before adding an existing capability
again. This documentation pass starts no implementation phase.

### Phase 16 — Schema & domain extension
