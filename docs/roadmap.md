...
> **Current roadmap (2026-09-06).** Phase 16 is complete; Phase 17 below is next.
...
| 17  | Evidence Enrichment & Context Re-attachment Service        | **Next — not started.** Bank statement ↔ SMS/push/receipt matching with local PII sanitization and traceable review.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
**Phase 17: Evidence Enrichment & Context Re-attachment Service.** Read
[ADR-0034](decisions/0034-evidence-linkage-is-write-once.md),
[ADR-0037](decisions/0037-receipt-payment-matching-surfaces-candidates-only.md), `CLAUDE.md`,
`docs/security/security-model.md` and `docs/architecture/data-flow.md` before implementation.
Inspect the current code and migrations before adding an existing capability again — phase 11
already surfaces deterministic receipt↔payment candidates, and phase 16's cash-flow
classification already exists to be fed by better evidence rather than rebuilt.
...
### Phase 17 — Evidence enrichment & context re-attachment service
