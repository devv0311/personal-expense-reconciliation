...
> either file. Future new ADRs continue after the highest existing number (currently 0050).
...
| [0050](0050-closing-the-audit-gaps-a-workflow-is-not-shipped-until-it-is-reachable.md)       | A capability is not shipped until a person can reach it                                    | Accepted                                                     |
| [0051](0051-reading-a-document-is-local-first-and-optical-only-by-opt-in.md)                 | Reading a document is local first, and optical only by opt-in                              | Accepted                                                     |
| [0052](0052-an-immutable-record-that-was-wrong-gets-a-successor-never-an-edit.md)            | An immutable record that was wrong gets a successor, never an edit                         | Accepted                                                     |
| [0053](0053-sending-a-proof-pack-is-a-recorded-outward-act.md)                               | Sending a proof pack is a recorded outward act, and never a settlement                     | Accepted                                                     |
| [0054](0054-a-live-balance-is-a-second-opinion-never-a-boundary.md)                          | A live balance is a second opinion, never a boundary                                       | Accepted                                                     |
| [0055](0055-a-correction-edits-the-entry-they-are-looking-at.md)                             | A Splitwise correction edits the entry they are looking at, never a second one             | Accepted                                                     |
| [0056](0056-a-change-made-in-splitwise-arrives-as-a-proposal.md)                             | A change made in Splitwise arrives as a proposal, never as an input                        | Accepted                                                     |
| [0057](0057-a-question-is-a-plan-over-reads-the-ledger-already-answers.md)                   | A question is a plan over reads the ledger already answers                                 | Accepted                                                     |
| [0058](0058-a-real-issuers-pdf-needs-a-standards-complete-local-reader.md)                   | A real issuer's PDF needs a standards-complete local reader (amends 0051)                  | Accepted                                                     |
| [0066](0066-a-bank-statement-is-read-by-its-columns-and-proved-by-its-balances.md)           | A bank statement is read by its columns, proved by its balances, read before written       | Accepted                                                     |
| [0067](0067-a-card-statement-names-its-account-whichever-layout-reads-it.md)                 | A card statement names its account too, whichever layout reads it (amends 0066)            | Accepted                                                     |
| [0068](0068-a-statement-that-cannot-name-its-account-is-named-by-the-person-importing-it.md) | A statement that cannot name its account is named by the person importing it (amends 0067) | Accepted                                                     |
| [0069](0069-two-lines-of-one-statement-are-two-movements.md)                                 | Two lines of one statement are two movements, not a possible duplicate (amends 0031)       | Accepted                                                     |
| [0070](0070-one-movement-recorded-twice-is-one-day-one-amount-one-name.md)                   | One movement recorded twice is one day, one amount and one name (amends 0069, 0031)        | Accepted — the owner's policy; live since 22 Sep 2026        |
