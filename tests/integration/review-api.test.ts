...
describe('the surface itself', () => {
  ...
  it('exposes its route table, so a Next.js mount is mechanical', () => {
    expect(api.routes.map((route) => `${route.method} ${route.path}`)).toEqual([
      ...
      'GET /api/accounts/:accountId/balance-readings',
      'GET /api/accounts',
      'POST /api/accounts',
      'POST /api/accounts/:accountId',
      'GET /api/balance-provider/status',
      'GET /api/balance-provider/links',
      'POST /api/balance-provider/links',
      'POST /api/balance-provider/links/:linkId/unlink',
      'POST /api/balance-provider/refresh',
      'GET /api/balance-provider/comparison',
      'GET /api/merchants',
      'POST /api/merchants',
      ...
      'GET /api/splitwise/remote-reads',
